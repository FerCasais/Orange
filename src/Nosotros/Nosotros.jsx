...
const Nosotros = () => {
  ...
  <Container>
    ...
    <div className='nosotros'><h3 className='mb-5'>Nosotros</h3>
    <h4 className='mb-3'>Quienes somos</h4>
    <p className='mb-3 '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempora perspiciatis amet asperiores nihil, repellendus aperiam quas alias rem doloremque dicta dolor fugiat sed fuga in aut quo accusamus? Neque, voluptate.
...
Cuando no se cuenta con un ERP se abre paso a la ineficiencia operativa, el retrabajo, los procesos propensos a errores, incómodos, manuales 
...
·  	No necesitan licencias , contarás con un módelo de S.A.A.S donde no tendrás que hacer mantenimientos, a través de la suscripción que canceles tendrás el derecho de usar todas las características de tu sistema 

·  	No necesitan backups , seguridad de la información confidencialidad. Ya no tendrás que preocuparte si se pierde o formatea tu computador, pues en la nube estraán las copias de seguridad 
·  	Incluyen actualizaciones y soporte. Contarás con  el acompañamiento necesario a través de una línea de soporte, y todas las mejoras del sistema
·  	Mejora la productividad. Tus colaboradores evitarán tareas manuales, ahorrarán tiempo y podrán invertirlo en actividades más estratégicas para  tu negocio 

Recuerda que lo que no se puede ver, no se puede medir y lo que no se puede medir no lo vas a poder gestionar, espero que te sean de utilidad estos tips 


Nicole Arroyo 
Docente de emprendimiento @cundigital
Emprendedora digital @naranjaerp
...
Que ventajas tiene un sistema en la nube frente a un sistema  local ¿ 
Toma de decisiones en tiempo real 
Automatizas procesos recurrentes . Los conteos manuales y las planillas en Excel han quedado en el pasado porque dan paso a errores y duplicación , se hace necesario la adquisición de tecnologías que permitan automatizar y simplificar los procesos asociados a los inventarios y estatus del stock.
Amigable con el medio ambiente 
No necesitan licencias 
No necesitan backups , seguridad de la información confidencialidad 
